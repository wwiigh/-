...
public class Show_item2 : MonoBehaviour
{
    ...
    Vector2 MousePos;
    Vector2 obj1Pos, obj2Pos, obj3Pos, obj4Pos,obj5Pos,obj6Pos;
    float ItemWidth;
    float ItemHight;
    void Start()
    {
    ...
    void OnEnable()
    {
        ...
        obj4Pos = obj4.GetComponent<Transform>().position;
        obj5Pos = obj5.GetComponent<Transform>().position;
        obj6Pos = obj6.GetComponent<Transform>().position;
        ...
        obj4Pos = Camera.main.WorldToScreenPoint(obj4Pos);
        obj5Pos = Camera.main.WorldToScreenPoint(obj5Pos);
        obj6Pos = Camera.main.WorldToScreenPoint(obj6Pos);
        ...
        obj4Pos = new Vector2(obj4Pos.x - ItemWidth/2, obj4Pos.y - ItemWidth/2);
        obj5Pos = new Vector2(obj5Pos.x - ItemWidth/2, obj5Pos.y - ItemWidth/2);
        obj6Pos = new Vector2(obj6Pos.x - ItemWidth/2, obj6Pos.y - ItemWidth/2);
    ...
    void Update()
    {
        ...
        if(WhereMouse > 0 && MousePos != LastMousePos){
            ...
            switch(WhereMouse){
                case 1:
                    item_name(get_Booty.get[0].id);
                    break;
                case 2:
                    item_name(get_Booty.get[1].id);
                    break;
                case 3:
                    item_name(get_Booty.get[2].id);       
                    break;
                case 4:
                    item_name(get_Booty.get[3].id);
                    break;
                case 5:
                    item_name(get_Booty.get[4].id);
                    break;
                case 6:
                    item_name(get_Booty.get[5].id);
                    break;
            }
    ...
    int WhereIsMouse(Vector2 Mouse){
        Debug.Log(Mouse.x + "and" + obj1Pos.x  + "ans1");
        Debug.Log(Mouse.x + "and" + obj2Pos.x  + "ans2");
        Debug.Log(Mouse.x + "and" + obj3Pos.x  + "ans3");
        Debug.Log(Mouse.x + "and" + obj4Pos.x  + "ans4");
